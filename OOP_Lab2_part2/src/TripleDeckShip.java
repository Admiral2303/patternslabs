public class TripleDeckShip extends Ship {
    private int  size = 3;
    private  int first_coordinate_x = 4;
    private  int first_coordinate_y = 0;
    private  int end_coordinate_x = 4;
    private  int end_coordinate_y = 2;
